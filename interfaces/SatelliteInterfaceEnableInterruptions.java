 ...
 */
public class SatelliteInterfaceEnableInterruptions  extends NetworkInterface {
	 ...
	 */
	public SatelliteInterfaceEnableInterruptions(Settings s)	{
		super(s);
	}
	 ...
	 */
	public SatelliteInterfaceEnableInterruptions(SatelliteInterfaceEnableInterruptions ni) {
		super(ni);
	}

	public NetworkInterface replicate()	{
		return new SatelliteInterfaceEnableInterruptions(this);
	}
