...
public class DijsktraSearchBasedonTemporalGraph extends ActiveRouter{
	/**自己定义的变量和映射等
	 * 
	 */
	 ...
	 * @param s
	 */
	public DijsktraSearchBasedonTemporalGraph (Settings s){
		super(s);
	}
	/**
	 * 初始化
	 * @param r
	 */
	protected DijsktraSearchBasedonTemporalGraph(DijsktraSearchBasedonTemporalGraph  r) {
		super(r);
	}
	/**
	 * 复制此router类
...
//		System.out.println("cost: "+ (t1-t0)+" TGMCostTime: "+TGMCostTime);
