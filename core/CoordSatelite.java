 ...
 * transformations
 */
public class CoordSatelite implements Cloneable, Comparable<CoordSatelite> {
    private double x;
    private double y;
    private double z;
     ...
     */
    public CoordSatelite(double x, double y) {
        setLocation(x,y);
    }
     ...
     */
    public void setLocation(CoordSatelite c) {
        this.x = c.x;
        this.y = c.y;
    }
     ...
     */
    public double distance(CoordSatelite other) {
     ...
     */
    public double distance2(CoordSatelite other) {
        double dx = this.x - other.x;
        double dy = this.y - other.y;
     ...
     */
    public double angle(CoordSatelite other) {
        double dx = this.x - other.x;
        double dy = this.y - other.y;
     ...
     */
    public boolean equals(CoordSatelite c) {
        if (c == this) {
            return true;
        }
        else {
     ...
     */
    public int compareTo(CoordSatelite other) {
        if (this.y < other.y) {
            return -1;
        }
    ...
    //×××××××××××××××我的扩展x
    public void my_Test(double time,double time_0) {
        ...
        this.x=500*Math.sin(s)+1000;
        this.y=500*Math.cos(s)+1000;
        this.z=230;
        //	this.x = 100;
        //	this.y = 200;
